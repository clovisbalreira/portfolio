...
let webSites = [
    ...
    {nome : 'Cartão Embarque', descricao : 'Este repositório contém um projeto HTML/CSS/JavaScript que gera cartões de embarque dinâmicos. O usuário pode gerar um novo cartão de embarque com detalhes aleatórios ao clicar em um botão. É uma excelente ferramenta para desenvolvedores e designers entenderem como integrar HTML, CSS e JavaScript para criar aplicações interativas.', 'Linguagem' : linguagens[1], 'Instrutores' : [instrutores[10]], 'Escolas' : escolas[12], site : './websites/rocketseat/bora-codar/cartao-embarque/index.html', github : 'rocketseat/bora-codar/cartao-embarque/'},
    {nome : 'Encontre seu Bloco', descricao : 'O projeto "Encontre seu bloco de carnaval" é uma página web interativa projetada para ajudar usuários a encontrar blocos de carnaval nas principais cidades brasileiras para o ano de 2023. Utilizando uma interface amigável e responsiva, o usuário pode buscar blocos por nome ou selecionar sua cidade para descobrir as melhores opções disponíveis.', 'Linguagem' : linguagens[1], 'Instrutores' : [instrutores[10]], 'Escolas' : escolas[12], site : './websites/rocketseat/bora-codar/cartao-embarque/index.html', github : 'rocketseat/bora-codar/encontre-bloco/'},
    {nome : 'Dashboard', descricao : 'O Dashboard é uma aplicação web dinâmica focada em exibir métricas de performance como NPS geral, vendas fechadas, meta mensal e vendas por dia da semana. Projetado para ser intuitivo e visualmente agradável, este dashboard utiliza uma série de tecnologias modernas para garantir uma experiência de usuário suave e informativa.', 'Linguagem' : linguagens[1], 'Instrutores' : [instrutores[10]], 'Escolas' : escolas[12], site : './websites/rocketseat/bora-codar/dashboard/index.html', github : 'rocketseat/bora-codar/dashboard/'}
]