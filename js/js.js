...
var tipos = [
    { nome: 'Site', descricao: 'Tipo site podendo ver o site no servidor.' }, 
...
var sites = [
    ...
    { titulo: 'Contabilidade', descricao: 'Projeto pessoal para contabilizar as contas.', linguagem: linguagens[0], url: 'sites/html_css_javascript/contabilidade/index.html', tipo: tipos[0], modelo: modelos[0], status: 'Não', projeto: projetos[0], tag: `${tags} ${tagsLinguagem[0]} #contabilidade`},
    ...
    { titulo: 'Curso em video', descricao: 'Projeto criado no modelo do curso em vídeo. Com mentoria de Gustavo Guanabara.', linguagem: linguagens[1], url: 'sites/html_css/curso_em_video/index.html', tipo: tipos[0], modelo: modelos[0], status: 'Sim', projeto: projetos[1], tag: `${tags} ${tagsLinguagem[1]} #cursoemvideo #gustavoguanabara`},    
    ...
    { titulo: 'Curso em video', descricao: 'Projeto criado no modelo do curso em vídeo. Com mentoria de Gustavo Guanabara.', linguagem: linguagens[2], url: 'sites/javascript/curso_em_video/index.html', tipo: tipos[0], modelo: modelos[0], status: 'Sim', projeto: projetos[1], tag: `${tags} ${tagsLinguagem[2]} #cursoemvideo #gustavoguanabara`},    
    ...
    { titulo: 'Acender Lambada', descricao: 'Projeto criado no modelo do curso em vídeo. Com mentoria de Gustavo Guanabara.', linguagem: linguagens[2], url: 'sites/html_css_javascript/curso_em_video_html_css_javascript/acenderLambada.html', tipo: tipos[0], modelo: modelos[0], status: 'Sim', projeto: projetos[1], tag: `${tags} ${tagsLinguagem[2]} #cursoemvideo #gustavoguanabara`},      { titulo: 'Clube', descricao: 'Projeto pessoal para uma associação de futebol de mesa.', tipo: tipos[0], linguagem: linguagens[3], url: 'http://lucfm.000webhostapp.com/', modelo: modelos[2], status: 'Sim', projeto: projetos[0], tag: `${tags} ${tagsLinguagem[3]}`},
    { titulo: 'Estudonauta', descricao: 'Projeto criado no modelo do estudonauta. Com mentoria de Gustavo Guanabara.', tipo: tipos[0], linguagem: linguagens[3], url: 'https://clovis-estudonauta.000webhostapp.com/', modelo: modelos[0], status: 'Sim', projeto: projetos[2], tag: `${tags} ${tagsLinguagem[3]} #estudonauta`},    
    ...
    [2], tag: `${tags} ${tagsLinguagem[5]} #cursoemvideo #gustavoguanabara`},    
    ...
    { titulo: 'Curso em video', descricao: 'Exercicios de java básico', linguagem: linguagens[6], url: 'https://github.com/clovisbalreira/curso_em_video_java_basico', tipo: tipos[1], modelo: modelos[3], status: 'Não', projeto: projetos[2], tag: `${tags} ${tagsLinguagem[6]}`},    
    ...
    { titulo: 'JavaScript - #7DaysOfCode - 1º dia', descricao: 'Projeto do desafio #7DaysOfCode', linguagem: linguagens[2], url: 'sites/html_css_javascript/alura_imersao_html/desafios/dia01.html', tipo: tipos[0], modelo: modelos[2], status: 'Sim', projeto: projetos[3], tag: `${tags}`},
    { titulo: 'JavaScript - #7DaysOfCode - 2º dia', descricao: 'Projeto do desafio #7DaysOfCode', linguagem: linguagens[2], url: 'sites/html_css_javascript/alura_imersao_html/desafios/dia02.html', tipo: tipos[0], modelo: modelos[0], status: 'Sim', projeto: projetos[3], tag: `${tags}`},
    /*{ titulo: '', descricao: '', linguagem: linguagens[9], url: '', tipo: tipos[0], modelo: modelos[2], status: 'Sim', projeto: projetos[0], tag: `${tags}`},*/
]
