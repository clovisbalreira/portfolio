...
var sites = [
    ...
    { titulo: 'Curso em video', descricao: 'Projeto criado no modelo do curso em vídeo. Com mentoria de Gustavo Guanabara.', linguagem: linguagens[2], url: 'sites/html_css_javascript/curso_em_video_html_css_javascript/acenderLambada.html', tipo: tipos[0], modelo: modelos[0], status: 'Sim', projeto: projetos[1], tag: `${tags} ${tagsLinguagem[2]} #cursoemvideo #gustavoguanabara`},      { titulo: 'Clube', descricao: 'Projeto pessoal para uma associação de futebol de mesa.', tipo: tipos[0], linguagem: linguagens[3], url: 'http://lucfm.000webhostapp.com/', modelo: modelos[2], status: 'Sim', projeto: projetos[0], tag: `${tags} ${tagsLinguagem[3]}`},
