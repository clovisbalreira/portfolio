...
async function getMovies(){
  const options = {
    ...
    headers: {
      ...
      Authorization: 'Bearer eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI5MDYwYWIyMjljY2M1YTZmN2YyZDIyMmQ4NWNiZTMzOSIsInN1YiI6IjYxM2NjMGY0NjBjNzUxMDA0MmU3MTBkMyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.9QCUlTiybTQNlr64xFEowTiRozrt5cZgXfmXMdlDyxk'
    }
  };
...
function createMovieLayout({
    ...
    <div class="movie">
        ...
        <div class="info">
            ...
            <div class="duration">
                <img src="./assets/icons/CalendarBlank.svg" alt="Calendário">
                <span>${year}</span>
            </div>
        </div>
...
async function start(){
    // pegar a sujestão dos filmes
    const { results } = await getMovies()
    // pegar randomicamnete 3 filmes
    const best3 = select3Videos(results).map( async movie => {
      //pegar informações extras
    ...
    // substituir o conteudo dos movies la no html
